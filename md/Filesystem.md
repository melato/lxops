...
Transient filesystems do not need to be preserved across reboots,
or backed-up.
A device where a transient filesystem is appropriate is /tmp.
Transient filesystems are ignored by the snapshot, export, import, and
copy-filesystems commands.
```
