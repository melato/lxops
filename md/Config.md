...
## image: (Pattern)
```
The image name used for launching an instance.
```
## origin: (Pattern)
```
The name of an instance and a snapshot to clone a new instance from. It has the form container/snapshot
```
