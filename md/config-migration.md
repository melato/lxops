## configuration file formats/migration
...
Instead, they can unmarshal the content to generic yaml data types, manipulate them, and marshal them back to binary data.
